...
from app.modules.ai.router import bp as ai_bp
...
from app.modules.house_video.router import bp as house_video_bp
...
def register_blueprints(app: Flask) -> None:
    ...
    app.register_blueprint(house_video_bp, url_prefix="/api/v1/houses")
